...
def collate_batch(batch):
    ...
    for b in batch:
        ...
        if with_labels: targets['labels'].append(b[1]['labels'])

    inputs['input_ids'] = pad_sequence(inputs['input_ids'], batch_first=True, padding_value=0)
    inputs['token_type_ids'] = pad_sequence(inputs['token_type_ids'], batch_first=True, padding_value=0)
